...
## Project Structure
    ...
    ├── findpro_employee_ag_37395  # Django project configurations
...
1. Clone this repo and `cd findpro_employee_ag_37395`
...
2. Clone this repo and `cd findpro_employee_ag_37395`
